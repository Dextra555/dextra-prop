          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box table-responsive">
                ...
                <div class="row">                   
                  <div class="col-md-4">                      
                     {{ html()->form('GET', url('/admin/sub_admin'))
                ...
                <div class="col-md-8">
                  <a href="{{URL::to('admin/sub_admin/add')}}" class="btn btn-success btn-md waves-effect waves-light m-b-20 mt-2 pull-right" data-toggle="tooltip" title="{{trans('words.add_admin')}}"><i class="fa fa-plus"></i> {{trans('words.add_admin')}}</a>
                </div>
              </div>
                  ...
                  <tbody>
                   @foreach($user_list as $i => $user_data)
                    <tr id="post_id_{{$user_data->id}}">
                      ...
                      <td>
                      <a href="{{ url('admin/sub_admin/edit/'.$user_data->id) }}" class="btn btn-icon waves-effect waves-light btn-success m-b-5 m-r-5" data-toggle="tooltip" title="{{trans('words.edit')}}"> <i class="fa fa-edit"></i> </a>
