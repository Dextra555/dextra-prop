          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card-box">
                ...
                {{ html()->form('POST', url('/admin/ad_list/applovins'))
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Native Ad ID</label>
                    <div class="col-sm-8">
                      <input type="text" name="native_id" value="{{ isset($ads_info->native_id) ? stripslashes($ads_info->native_id) : null }}" class="form-control">
                    </div>
                  </div>
