          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card-box">
                ...
                {{ html()->form('POST', url('/admin/payment_gateway/sslcommerz'))
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="store_id" value="{{ isset($gateway_info->store_id) ? stripslashes($gateway_info->store_id) : null }}" class="form-control">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Store Password</label>
                    <div class="col-sm-8">
                      <input type="text" name="store_password" value="{{ isset($gateway_info->store_password) ? stripslashes($gateway_info->store_password) : null }}" class="form-control">
                    </div>
                  </div>
