              ...
              <div class="card-box table-responsive">
                ...
                <div class="col-md-3">
                  <span data-toggle="modal" data-target="#add_model">
                    <a href="#" class="btn btn-success btn-md waves-effect waves-light m-b-20" data-toggle="tooltip" title="{{trans('words.add_location')}}"><i class="fa fa-plus"></i> {{trans('words.add_location')}}</a>
                  </span>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content pt-3 pb-3 pl-0 pr-0">
                                <div class="modal-header pl-3 pr-3">
                                    <h4 class="modal-title mt-0" id="myModalLabel">{{trans('words.add_location')}}</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                </div>
                                <div class="modal-body pl-3 pr-3 pt-3 pb-0">
 

                                 {{ html()->form('POST', url('/admin/location/add_edit'))
                                  ->attributes(['class' => 'form-horizontal', 'id' => 'post_form', 'name' => 'post_form', 'role' => 'form', 'enctype' => 'multipart/form-data'])->open() }}
                                    
                                  <div class="form-group row">    
                                    <label class="col-sm-4 col-form-label">{{trans('words.location_name')}}</label>
                                    <div class="col-sm-8">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6" id="card_box_id_{{$data->id}}">
                        ...
                        <div class="card m-b-20 p-3 lng_item_grid">
                            <div class="card-body p-0">
								...
								<div class="item_latter">{{ stripslashes($data->name) }}</div>
                                <span data-toggle="modal" data-target="#edit_model{{$data->id}}">
                                    <a href="#" class="btn btn-icon waves-effect waves-light btn-success m-r-5" data-toggle="tooltip" title="{{trans('words.edit')}}"><i class="fa fa-edit"></i></a>
                                </span>
                                <div id="edit_model{{$data->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                  <div class="modal-dialog modal-dialog-centered">
                                      <div class="modal-content pt-3 pb-3 pl-0 pr-0">
                                          <div class="modal-header pl-3 pr-3">
                                              <h4 class="modal-title mt-0" id="myModalLabel">{{trans('words.edit_location')}}</h4>
                                              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                          </div>
                                          <div class="modal-body pl-3 pr-3 pt-3 pb-0">
                                          ...
                                          <input type="hidden" name="id" value="{{ $data->id }}">
                                            <div class="form-group row">    
                                              <label class="col-sm-4 col-form-label">{{trans('words.location_name')}}</label>
                                              <div class="col-sm-8">
                                                <input type="text" name="name" value="{{stripslashes($data->name)}}" class="form-control">
                                              </div>
                                            </div>
                                            ...
                                            <div class="form-group row">    
                                              ...
                                              <div class="col-sm-8">
                                              <select class="form-control" name="status">                               
                                                  <option value="1" @if($data->status==1) selected @endif>{{trans('words.active')}}</option>
                                                  <option value="0" @if($data->status==0) selected @endif>{{trans('words.inactive')}}</option>                            
                                              </select>
                                              </div>
                                            </div>                                   
                                          </div>
