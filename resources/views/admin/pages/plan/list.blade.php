          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box table-responsive">
                ...
                <div class="col-md-12">
                  <a href="{{URL::to('admin/subscription_plan/add')}}" class="btn btn-success btn-md waves-effect waves-light m-b-20 pull-right" data-toggle="tooltip" title="{{trans('words.add_plan')}}"><i class="fa fa-plus"></i> {{trans('words.add_plan')}}</a>
                </div>
              </div>
                ...
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      ...
                      <th>{{trans('words.property_limit')}}</th>
                  ...
                  <tbody>
                   @foreach($plan_list as $i => $plan_data)
                    <tr id="card_box_id_{{$plan_data->id}}">
                      ...
                      <td>{{ $plan_data->plan_property_limit }}</td>
                      ...
                      <td>
                      <a href="{{ url('admin/subscription_plan/edit/'.$plan_data->id) }}" class="btn btn-icon waves-effect waves-light btn-success m-r-5" data-toggle="tooltip" title="{{trans('words.edit')}}"> <i class="fa fa-edit"></i> </a>
                      
                      <a href="#" class="btn btn-icon waves-effect waves-light btn-danger data_remove" data-toggle="tooltip" title="{{trans('words.remove')}}" data-id="{{$plan_data->id}}"> <i class="fa fa-remove"></i> </a>             
                      </td>
                    </tr>
                   @endforeach
