...
@section('head_title', trans('words.search_properties_result').' - '.getcong('site_name') )
      ...
      <div class="row">
        <div class="col-md-8 offset-md-2 text-center">
          <div class="breadcrumb-menu">
            <h2>{{trans('words.search_properties_result')}} </h2>
            <span><a href="{{ URL::to('/') }}" title="{{trans('words.home')}}">{{trans('words.home')}}</a></span> <span>{{trans('words.search_properties_result')}}</span> 
		      </div>
        </div>
      </div>
    </div>
