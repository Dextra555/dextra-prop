...
<tbody>
<tr>
<td><a href="{{ url('/') }}" target="_blank"><img style="border:0;display:block;outline:none;text-decoration:none;height:auto;min-width: 20%;width: 40%;max-width: 100%;font-size: 13px;margin: 0 auto;padding: 25px;" src="{{ URL::asset('/'.getcong('site_logo')) }}" width="200" height="25" style="width:200px;height:25px"></a></td> 
</tr>
</tbody>
</table>
</td>
...
<div style="font-family:Helvetica Neue, Helvetica, Arial;font-size:16px;line-height:24px;text-align:left;color:#282828">Hello User,</div>
</td>
</tr> 
<tr>
<td dir="ltr" style="font-size:0px;padding:5px 5px 5px 5px;word-break:break-word" align="left">
<div style="font-family:Helvetica Neue, Helvetica;font-size:16px;line-height:24px;text-align:left;color:#282828">You have requested to reset your password<br/>

<strong>Your New Password is:</strong> {{$password}}
</div>
...
<a href="{{stripslashes(getcong('facebook_link'))}}" target="_blank" style="color:#1e2026">Facebook</a> | 
<a href="{{stripslashes(getcong('instagram_link'))}}" target="_blank" style="color:#1e2026">Instagram</a> | 
<a href="{{stripslashes(getcong('twitter_link'))}}" target="_blank" style="color:#1e2026">Twitter</a> |
<a href="{{stripslashes(getcong('youtube_link'))}}" target="_blank" style="color:#1e2026">YouTube</a>  
</td>
</tr>
</tbody>
</table>
