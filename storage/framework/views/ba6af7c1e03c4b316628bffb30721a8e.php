...
<tbody>
<tr>
<td><a href="<?php echo e(url('/')); ?>" target="_blank"><img style="border:0;display:block;outline:none;text-decoration:none;height:auto;min-width: 20%;width: 40%;max-width: 100%;font-size: 13px;margin: 0 auto;padding: 25px;" src="<?php echo e(URL::asset('/'.getcong('site_logo'))); ?>" width="200" height="25" style="width:200px;height:25px"></a></td> 
</tr>
</tbody>
</table>
</td>
...
<div style="font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:22px;font-weight:900;line-height:28px;text-align:left;color:#000000">Welcome to <?php echo e(getcong('site_name')); ?></div>
</td>
</tr>
<tr>
<td dir="ltr" style="font-size:0px;padding:5px 5px 5px 5px;word-break:break-word" align="left">
<div style="font-family:Helvetica Neue, Helvetica, Arial;font-size:16px;line-height:24px;text-align:left;color:#282828">Hi <?php echo e($name); ?>,</div>
</td>
</tr> 
<tr>
<td dir="ltr" style="font-size:0px;padding:5px 5px 5px 5px;word-break:break-word" align="left">
...
<a href="<?php echo e(stripslashes(getcong('facebook_link'))); ?>" target="_blank" style="color:#1e2026">Facebook</a> | 
<a href="<?php echo e(stripslashes(getcong('instagram_link'))); ?>" target="_blank" style="color:#1e2026">Instagram</a> | 
<a href="<?php echo e(stripslashes(getcong('twitter_link'))); ?>" target="_blank" style="color:#1e2026">Twitter</a> |
<a href="<?php echo e(stripslashes(getcong('youtube_link'))); ?>" target="_blank" style="color:#1e2026">YouTube</a>
</td>
</tr>
</tbody>
</table>
...
<div style="font-family:Helvetica Neue, Helvetica;font-size:14px;font-weight:500;line-height:16px;text-align:center;color:#1e2026">© <?php echo e(date('Y')); ?> <?php echo e(getcong('site_name')); ?>, All Rights Reserved.</div>
</td>
</tr>
</tbody>
</table>
...
</html><?php /**PATH C:\Users\USER\Documents\Dextra Properties\realestate.dextragroups.com\realestate.dextragroups.com\resources\views/emails/test_smtp.blade.php ENDPATH**/ ?>