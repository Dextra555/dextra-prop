<?php $__env->startSection('head_title', $type_info->type_name.' '.trans('words.property_text').' - '.getcong('site_name') ); ?>
...
<script type="application/ld+json">
    {
        ...
        "@type": "ItemList",
        "name": "<?php echo e($type_info->type_name); ?> <?php echo e(trans('words.property_text')); ?>",
        "description": "",
        "itemListElement": [
          <?php $i = 1; ?> 
      ...
      <div class="row">
        <div class="col-md-8 offset-md-2 text-center">
          <div class="breadcrumb-menu">
            <h2><?php echo e($type_info->type_name); ?> - <?php echo e(trans('words.property_text')); ?> </h2>
            <span><a href="<?php echo e(URL::to('/')); ?>"><?php echo e(trans('words.home')); ?></a></span> <span><?php echo e($type_info->type_name); ?> - <?php echo e(trans('words.property_text')); ?></span> 
		      </div>
        </div>
      </div>
    </div>
			 ...
			 <div class="row align-items-center">
				<div class="col-lg-6 col-sm-6 col-12">
				  <div class="item-element res-box text-left sm-left">
					<p>Showing <span><?php echo e($property_list->firstItem()); ?>-<?php echo e($property_list->lastItem()); ?></span> of <span><?php echo e($property_list->total()); ?></span> Properties</p>
				  </div>
				</div>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dextragr/public_html/realestate.dextragroups.com/resources/views/pages/types/property_list.blade.php ENDPATH**/ ?>