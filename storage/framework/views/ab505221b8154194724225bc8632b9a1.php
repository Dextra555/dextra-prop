<?php $__env->startSection('head_title', trans('words.trending_now').' - '. getcong('site_name') ); ?>
      ...
      <div class="row">
        <div class="col-md-8 offset-md-2 text-center">
          <div class="breadcrumb-menu">
            ...
            <span><a href="<?php echo e(URL::to('/')); ?>" title="<?php echo e(trans('words.home')); ?>"><?php echo e(trans('words.home')); ?></a></span> <span><?php echo e(trans('words.trending_now')); ?></span> 
		      </div>
        </div>
      </div>
    </div>
                ...
                <div class="tab-pane fade show active property-grid" id="grid-view">
                  ...
                  <div class="col-xl-4 col-md-6 col-sm-12">
                      <div class="vfx-single-property-box-area">
                        <div class="vfx-property-item"> <a class="vfx-property-img" href="<?php echo e(URL::to('properties/'.$property_info->slug.'/'.$property_info->id)); ?>" title="<?php echo e(stripslashes($property_info->title)); ?>"><img src="<?php echo e(\URL::to('/'.$property_info->image)); ?>" alt="#" title="<?php echo e(stripslashes($property_info->title)); ?>"> </a>
                          ...
                          <?php if(check_favourite("Property",$property_info->id,isset(Auth::user()->id)?Auth::user()->id:"")): ?> 
                            <li data-toggle="tooltip" data-placement="top" title="" data-original-title="Favourite" class="favourite_property favourite_title_id<?php echo e($property_info->id); ?>" data-id="<?php echo e($property_info->id); ?>">
                              
                              <a href="Javascript:void(0);" title="fav"><i class="fa fa-heart favourite_icon_id<?php echo e($property_info->id); ?>"></i></a>
                          ...
                          <?php else: ?>
                            <li data-toggle="tooltip" data-placement="top" title="" data-original-title="Set Favourite" class="favourite_property favourite_title_id<?php echo e($property_info->id); ?>" data-id="<?php echo e($property_info->id); ?>">
                              ...
                              <a href="Javascript:void(0);" title="fav"><i class="fa fa-heart-o favourite_icon_id<?php echo e($property_info->id); ?>"></i></a>
                        ...
                        <div class="vfx-property-title-box-area">
                          ...
                          <div class="trending-bottom">
                            <div class="trend-left float-left">
                              <div class="vfx-property-author-wrap"> <a href="<?php echo e(URL::to('properties/owner/'.$property_info->user_id)); ?>" class="property-author" title="<?php echo e(stripslashes($property_info->title)); ?>"> 
                              ...
                              <span><?php echo e($property_info->users->name); ?></span> </a></div>
                            </div>
                            <a href="<?php echo e(URL::to('properties/'.$property_info->slug.'/'.$property_info->id)); ?>" class="vfx-trend-right float-right">
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dextragr/public_html/realestate.dextragroups.com/resources/views/pages/home/popular.blade.php ENDPATH**/ ?>