                ...
                <div class="row">
                  <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6">
                        <!-- Simple card -->
                        <div class="card m-b-20 p-3 ads_block">
                            <div class="ads_logo_item">
                            ...
                            <div class="card-body p-0">
                                <h4 class="card-title mb-4"><?php echo e(stripslashes($data->gateway_name)); ?></h4>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dextragr/public_html/realestate.dextragroups.com/resources/views/admin/pages/gateway/list.blade.php ENDPATH**/ ?>