          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box table-responsive">
                ...
                <div class="col-md-12">
                  <a href="<?php echo e(URL::to('admin/pages/add')); ?>" class="btn btn-success btn-md waves-effect waves-light m-b-20 pull-right" data-toggle="tooltip" title="<?php echo e(trans('words.add_page')); ?>"><i class="fa fa-plus"></i> <?php echo e(trans('words.add_page')); ?></a>
                </div>
              </div>
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                   <?php $__currentLoopData = $pages_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr id="post_id_<?php echo e($page->id); ?>">
                      ...
                      <a href="<?php echo e(url('page/'.$page->page_slug)); ?>" class="btn btn-icon waves-effect waves-light btn-info m-b-5 m-r-5" data-toggle="tooltip" title="<?php echo e(trans('words.preview')); ?>" target="_blank"> <i class="fa fa-link"></i> </a>  
                      ...
                      <?php if($page->id > 5): ?>
                      <a href="#" class="btn btn-icon waves-effect waves-light btn-danger data_remove m-b-5" data-toggle="tooltip" title="<?php echo e(trans('words.remove')); ?>" data-id="<?php echo e($page->id); ?>"> <i class="fa fa-remove"></i> </a>
                      <?php endif; ?>                      
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dextragr/public_html/realestate.dextragroups.com/resources/views/admin/pages/pages/list.blade.php ENDPATH**/ ?>