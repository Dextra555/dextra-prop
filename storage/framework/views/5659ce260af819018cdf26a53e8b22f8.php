              ...
              <div class="card-box table-responsive">
                ...
                <div class="row">
                 <div class="col-md-4"> 
                     ...
                     <?php echo e(html()->form('GET', url('/admin/type'))
                ...
                <div class="col-md-8">
                  <a href="<?php echo e(URL::to('admin/type/add')); ?>" class="btn btn-success btn-md waves-effect waves-light m-b-20 mt-2 pull-right" data-toggle="tooltip" title="<?php echo e(trans('words.add_type')); ?>"><i class="fa fa-plus"></i> <?php echo e(trans('words.add_type')); ?></a>
                </div>
              </div>
                  ...
                  <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6" id="card_box_id_<?php echo e($data->id); ?>">
                        ...
                        <div class="card m-b-20">
                            ...
                            <?php if(isset($data->type_image)): ?> <img class="card-img-top thumb-md img-fluid" src="<?php echo e(URL::to('/'.$data->type_image)); ?>" alt="<?php echo e(stripslashes($data->type_name)); ?>"> <?php endif; ?>
 

                            <div class="card-body p-3">
                                <h4 class="card-title mb-3"><?php echo e(stripslashes($data->type_name)); ?></h4>
                                
                                <a href="<?php echo e(url('admin/type/edit/'.$data->id)); ?>" class="btn btn-icon waves-effect waves-light btn-success m-r-5" data-toggle="tooltip" title="<?php echo e(trans('words.edit')); ?>"> <i class="fa fa-edit"></i> </a>
                                ...
                                <a href="Javascript:void(0);" class="ml-2" data-toggle="tooltip" title="<?php if($data->status==1): ?><?php echo e(trans('words.active')); ?> <?php else: ?> <?php echo e(trans('words.inactive')); ?> <?php endif; ?>"><input type="checkbox" name="type_on_off" id="type_on_off" value="1" data-plugin="switchery" data-color="#28a745" data-size="small" class="enable_disable"  data-id="<?php echo e($data->id); ?>" <?php if($data->status==1): ?> <?php echo e('checked'); ?> <?php endif; ?>/></a>    
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Documents\Dextra Properties\realestate.dextragroups.com\realestate.dextragroups.com\resources\views/admin/pages/type/list.blade.php ENDPATH**/ ?>